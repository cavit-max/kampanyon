...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/kampanyalar.css">
	<link rel="stylesheet" type="text/css" href="css/basliklar.css">
	<link rel="stylesheet" type="text/css" href="css/kampanyaKutu.css">
	<script src="js/container.js"></script>
	<script src="js/reklam.js"></script>
	<script src="js/kampanyalar.js"></script>
	<script src="js/favoriEkle.js"></script>
...
<body>
	...
	<div class="sliderReklam">
		<div class="sliderReklamPhoto">
			<a class="prev" onclick="prevSlide()">&#10094;</a>
			<img src="img/kampanya1.jpg" alt="Slide 1" />
			<img src="img/kampanya2.jpg" alt="Slide 2" />
			<img src="img/kampanya3.jpg" alt="Slide 3" />
	...
	<div class="basliklar">
		...
		if (isset($_GET['kategoriID'])) {
			$kategori = $_GET['kategoriID'];

			$kategoriBaslik = '';
			if ($kategori == 1) {
				$kategoriBaslik = 'Restoran & Kafe Kategori Sonuçları';
			} elseif ($kategori == 2) {
				$kategoriBaslik = 'Supermarket Kategori Sonuçları';
			} elseif ($kategori == 3) {
				$kategoriBaslik = 'Giyim & Aksesuar Kategori Sonuçları';
			} elseif ($kategori == 4) {
				$kategoriBaslik = 'Elektronik Kategori Sonuçları';
			} elseif ($kategori == 5) {
				$kategoriBaslik = 'Ev & Yaşam Kategori Sonuçları';
			} elseif ($kategori == 6) {
				$kategoriBaslik = 'Aktivite & Eğlence Kategori Sonuçları';
			} elseif ($kategori == 7) {
				$kategoriBaslik = 'Spor & Outdoor Kategori Sonuçları';
			} elseif ($kategori == 8) {
				$kategoriBaslik = 'Sağlık Kategori Sonuçları';
			} elseif ($kategori == 9) {
				$kategoriBaslik = 'Hizmet Kategori Sonuçları';
			}

			// Başlığı yazdır
			echo '<h2>' . $kategoriBaslik . '</h2>';
		} elseif (isset($_GET['altKategoriID'])) {
			$altKategori = $_GET['altKategoriID'];

			$altKategoriBaslik = '';
			if ($altKategori == 10) {
				$altKategoriBaslik = 'Kahvaltılar Kategori Sonuçları';
			} elseif ($altKategori == 11) {
				$altKategoriBaslik = 'Kafeler Kategori Sonuçları';
			} elseif ($altKategori == 12) {
				$altKategoriBaslik = 'Fast Foodlar Kategori Sonuçları';
			} elseif ($altKategori == 13) {
				$altKategoriBaslik = 'Geleneksel Yemekler Kategori Sonuçları';
			} elseif ($altKategori == 14) {
				$altKategoriBaslik = 'Deniz Ürünleri Kategori Sonuçları';
			} elseif ($altKategori == 15) {
				$altKategoriBaslik = 'Barlar & Gece Kulübü Kategori Sonuçları';
			} elseif ($altKategori == 16) {
				$altKategoriBaslik = 'Pastane & Tatlıcılar Kategori Sonuçları';
			} elseif ($altKategori == 17) {
				$altKategoriBaslik = 'Dünya Mutfağı Kategori Sonuçları';
			} elseif ($altKategori == 18) {
				$altKategoriBaslik = 'Vejetaryen ve Vegan Yemekler Kategori Sonuçları';
			} elseif ($altKategori == 19) {
				$altKategoriBaslik = 'Diğer Kategori Sonuçları';
			} elseif ($altKategori == 20) {
				$altKategoriBaslik = 'Sebze-Meyve Kategori Sonuçları';
			} elseif ($altKategori == 21) {
				$altKategoriBaslik = 'Temel Gıda Kategori Sonuçları';
			} elseif ($altKategori == 22) {
				$altKategoriBaslik = 'Ekmek & Fırın Kategori Sonuçları';
			} elseif ($altKategori == 23) {
				$altKategoriBaslik = 'Su & İçecek Kategori Sonuçları';
			} elseif ($altKategori == 24) {
				$altKategoriBaslik = 'Süt & Kahvaltılık Kategori Sonuçları';
			} elseif ($altKategori == 25) {
				$altKategoriBaslik = 'Et & Balık Kategori Sonuçları';
			} elseif ($altKategori == 26) {
				$altKategoriBaslik = 'Atıştırmalıklar Kategori Sonuçları';
			} elseif ($altKategori == 27) {
				$altKategoriBaslik = 'Hazır Gıdalar Kategori Sonuçları';
			} elseif ($altKategori == 28) {
				$altKategoriBaslik = 'Temizlik Malzemeleri Kategori Sonuçları';
			} elseif ($altKategori == 29) {
				$altKategoriBaslik = 'Kişisel Bakım Kategori Sonuçları';
			} elseif ($altKategori == 30) {
				$altKategoriBaslik = 'Ev Gereçleri Kategori Sonuçları';
			} elseif ($altKategori == 31) {
				$altKategoriBaslik = 'Petshop Kategori Sonuçları';
			} elseif ($altKategori == 32) {
				$altKategoriBaslik = 'Kadın Giyim Kategori Sonuçları';
			} elseif ($altKategori == 33) {
				$altKategoriBaslik = 'Erkek Giyim Kategori Sonuçları';
			} elseif ($altKategori == 34) {
				$altKategoriBaslik = 'Çocuk Giyim Kategori Sonuçları';
			} elseif ($altKategori == 35) {
				$altKategoriBaslik = 'Ayakkabı Kategori Sonuçları';
			} elseif ($altKategori == 36) {
				$altKategoriBaslik = 'Çanta Kategori Sonuçları';
			} elseif ($altKategori == 37) {
				$altKategoriBaslik = 'Saat & Aksesuar Kategori Sonuçları';
			} elseif ($altKategori == 38) {
				$altKategoriBaslik = 'Bilgisayar & Tablet Kategori Sonuçları';
			} elseif ($altKategori == 39) {
				$altKategoriBaslik = 'Yazııclar & Projeksiyon Kategori Sonuçları';
			} elseif ($altKategori == 40) {
				$altKategoriBaslik = 'Telefon & Telefon Aksesuarları Kategori Sonuçları';
			} elseif ($altKategori == 41) {
				$altKategoriBaslik = 'TV, Görüntü & Ses Sistemleri Kategori Sonuçları';
			} elseif ($altKategori == 42) {
				$altKategoriBaslik = 'Beyaz Eşya Kategori Sonuçları';
			} elseif ($altKategori == 43) {
				$altKategoriBaslik = 'Klima ve Isıtıcılar Kategori Sonuçları';
			} elseif ($altKategori == 44) {
				$altKategoriBaslik = 'Elektrikli Ev Aletleri Kategori Sonuçları';
			} elseif ($altKategori == 45) {
				$altKategoriBaslik = 'Foto & Kamera Kategori Sonuçları';
			} elseif ($altKategori == 46) {
				$altKategoriBaslik = 'Oyun & Oyun Konsolları Kategori Sonuçları';
			} elseif ($altKategori == 47) {
				$altKategoriBaslik = 'Softa & Mutfak Kategori Sonuçları';
			} elseif ($altKategori == 48) {
				$altKategoriBaslik = 'Banyo Kategori Sonuçları';
			} elseif ($altKategori == 49) {
				$altKategoriBaslik = 'Ev Tekstili Kategori Sonuçları';
			} elseif ($altKategori == 50) {
				$altKategoriBaslik = 'Ev Dekorasyon Kategori Sonuçları';
			} elseif ($altKategori == 51) {
				$altKategoriBaslik = 'Mobilya Kategori Sonuçları';
			} elseif ($altKategori == 52) {
				$altKategoriBaslik = 'Aydınlatma Kategori Sonuçları';
			} elseif ($altKategori == 53) {
				$altKategoriBaslik = 'Ev Gereçleri Kategori Sonuçları';
			} elseif ($altKategori == 54) {
				$altKategoriBaslik = 'Hobi Ürünleri Kategori Sonuçları';
			} elseif ($altKategori == 55) {
				$altKategoriBaslik = 'Kırtasiye & Ofis Kategori Sonuçları';
			} elseif ($altKategori == 56) {
				$altKategoriBaslik = 'Yapı Market Kategori Sonuçları';
			} elseif ($altKategori == 57) {
				$altKategoriBaslik = 'Otomobil & Motorsiklet Kategori Sonuçları';
			} elseif ($altKategori == 58) {
				$altKategoriBaslik = 'Sinema Kategori Sonuçları';
			} elseif ($altKategori == 59) {
				$altKategoriBaslik = 'Tiyatro Kategori Sonuçları';
			} elseif ($altKategori == 60) {
				$altKategoriBaslik = 'Konserler Kategori Sonuçları';
			} elseif ($altKategori == 61) {
				$altKategoriBaslik = 'Müzeler Kategori Sonuçları';
			} elseif ($altKategori == 62) {
				$altKategoriBaslik = 'Eğlence Merkezleri Kategori Sonuçları';
			} elseif ($altKategori == 63) {
				$altKategoriBaslik = 'Oyun Salonları Kategori Sonuçları';
			} elseif ($altKategori == 64) {
				$altKategoriBaslik = 'Sanat Atölyeleri Kategori Sonuçları';
			} elseif ($altKategori == 65) {
				$altKategoriBaslik = 'Gezilecek Yerler Kategori Sonuçları';
			} elseif ($altKategori == 66) {
				$altKategoriBaslik = 'Online Kurslar Kategori Sonuçları';
			} elseif ($altKategori == 67) {
				$altKategoriBaslik = 'Spor Malzemeleri Kategori Sonuçları';
			} elseif ($altKategori == 68) {
				$altKategoriBaslik = 'Dil Kursları Kategori Sonuçları';
			} elseif ($altKategori == 69) {
				$altKategoriBaslik = 'Kişisel Gelişim Kursları Kategori Sonuçları';
			} elseif ($altKategori == 70) {
				$altKategoriBaslik = 'Spor Salonları Kategori Sonuçları';
			} elseif ($altKategori == 71) {
				$altKategoriBaslik = 'Doğa Sporları Kategori Sonuçları';
			} elseif ($altKategori == 72) {
				$altKategoriBaslik = 'Su Sporları Kategori Sonuçları';
			} elseif ($altKategori == 73) {
				$altKategoriBaslik = 'Yoga Kategori Sonuçları';
			} elseif ($altKategori == 74) {
				$altKategoriBaslik = 'Diğer Sporlar Kategori Sonuçları';
			} elseif ($altKategori == 75) {
				$altKategoriBaslik = 'Hastaneler Kategori Sonuçları';
			} elseif ($altKategori == 76) {
				$altKategoriBaslik = 'Veterinerler Kategori Sonuçları';
			} elseif ($altKategori == 77) {
				$altKategoriBaslik = 'Psikolog & Ruh Sağlığı Kategori Sonuçları';
			} elseif ($altKategori == 78) {
				$altKategoriBaslik = 'Eczaneler Kategori Sonuçları';
			} elseif ($altKategori == 79) {
				$altKategoriBaslik = 'Hayvan Sağlığı Kategori Sonuçları';
			} elseif ($altKategori == 80) {
				$altKategoriBaslik = 'Kurye & Nakliyat Kategori Sonuçları';
			} elseif ($altKategori == 81) {
				$altKategoriBaslik = 'Danışmanlık Kategori Sonuçları';
			} elseif ($altKategori == 82) {
				$altKategoriBaslik = 'Emlak Kategori Sonuçları';
			} elseif ($altKategori == 83) {
				$altKategoriBaslik = 'Oto Galeri Kategori Sonuçları';
			} elseif ($altKategori == 84) {
				$altKategoriBaslik = 'Konaklama & Otel Kategori Sonuçları';
			} elseif ($altKategori == 85) {
				$altKategoriBaslik = 'Gezi Turları & Rehberlik Kategori Sonuçları';
			}

			// Başlığı yazdır
			echo '<h2>' . $altKategoriBaslik . '</h2>';
		} else {
	...
	<div class="content">
		...
		<div class="kampanyalarGosterim">
			...
			if (isset($_GET['kategoriID'])) {
				...
				$sql = "SELECT * FROM ilanlar WHERE kategori = $kategori";
				...
				if ($result->num_rows > 0) {
					...
					if (isset($_GET['altKategoriID'])) {
				$altKategori = $_GET['altKategoriID'];

				// İlanları veritabanından çek ve alt kategoriye göre filtrele
				$sql = "SELECT * FROM ilanlar WHERE altKategori = $altKategori";
				$result = $conn->query($sql);
