...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/kampanyaGosterim.css">
	...
	<script src="js/kampanyaGosterim.js"></script>
	...
	<div class="content">
		...
		<div class="container41">
			...
			if (isset($_GET['ilanID'])) {
				...
				$sql = "SELECT * FROM ilanlar WHERE id = $ilanID";
				...
				if ($result->num_rows > 0) {
					...
					<div class="right">
						<p class="baslik">' . $ilan["baslik"] . '</p>
						<p class="oran">' . $ilan["oran"] . '</p>
						<p class="aciklama">' . $ilan["aciklama"] . '</p>
						<p class="adres">İzmir, Buca</p>
					</div>
						';
						echo $kampanyaHTML;
					}
