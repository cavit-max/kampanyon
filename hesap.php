...
if (isset($_SESSION['loggedinKullanici']) && $_SESSION['loggedinKullanici'] === true) {
	...
	$sql = "SELECT ad, soyad, dogum_tarihi, eposta, telefon, sifre FROM kullanicilar WHERE id='$kullaniciID'";
...
<body>
	...
	<div class="content">
		<div class="hesapSidebar">
			...
			<img class="hesapLogo" src="img/kullanicilar/cavit.png">
			<span class="hesapIsim"><?php echo $kullaniciAdi; ?></span>
			<div class="hesapSpan">
				<span class="span"><a href="#" id="hesapBilgiClick">Hesap Bilgilerim</a></span>
				<span class="span"><a href="#" id="favorilerimClick">Favorilerim</a></span>
				...
				<form action="hesap.php" method="POST">
					<div class="adSoyad">
						<div class="formGrup">
							...
							<input type="text" id="ad" name="ad" value="<?php echo $kullaniciAdi; ?>" required>
						</div>
						<div class="formGrup">
							<label for="soyad">Soyad:</label>
							<input type="text" id="soyad" name="soyad" value="<?php echo $kullaniciSoyadi; ?>" required>
						</div>
					</div>

					<div class="formGrup">
						<label for="dogum_tarihi">Doğum Tarihi:</label>
						<input type="date" id="dogum_tarihi" name="dogum_tarihi" value="<?php echo $dogum_tarihi; ?>" required>
					</div>
					<div class="formGrup">
						<label for="email">E-Posta:</label>
						<input type="email" id="email" name="email" value="<?php echo $eposta; ?>" required>
					</div>
					<div class="formGrup">
						<label for="telefon">Telefon:</label>
						<input type="tel" id="telefon" name="telefon" value="<?php echo $telefon; ?>" required>
					</div>
					<div class="formGrup">
						<label for="telefon">Şifre</label>
						<input type="password" id="sifre" name="sifre" value="<?php echo $sifre; ?>" required>
					</div>
					<div class="formGrup">
		...
		<div class="favoriler" id="favorilerim">
			...
			<div class=hesapBilgiBaslik>
				<h2 class="baslik">Favorilerim</h2>
			</div>
			<div class="satir"></div>
			...
			<div class="kampanyaListe">
				...
				$sql = "SELECT ilanlar.*
						FROM ilanlar
						JOIN favoriler ON ilanlar.id = favoriler.ilan_id
						WHERE favoriler.kullanici_id = 12";
				$result = $conn->query($sql);
