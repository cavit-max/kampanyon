...
<body>
	<div class="container">
		...
		<div class="kategoriDiv" onmouseleave="hidePopupKategori()">
			...
			<div class="cizgi">|</div>
			<div class="anaKategori" onclick="setKategoriID(2)" onmouseenter="showPopupKategori('marketPopup')">SÜPERMARKET</div>
	...
	<div class="content">
		...
		<div class=anasayfaKampanya>

			<h1>RESTORAN & KAFE KAMPANYALARI</h1>

			<div class="kampanyaSlider">
				<div class="kampanyaListe">
					<?php
					// İlanları veritabanından çek ve kategoriye göre filtrele
					$sql = "SELECT * FROM ilanlar WHERE kategori = 1";
		...
		<div class=anasayfaKampanya>
			<h1>SUPERMARKET KAMPANYALARI</h1>
			<div class="kampanyaSlider">
				<div class="kampanyaListe">
					<?php
					// İlanları veritabanından çek ve kategoriye göre filtrele
					$sql = "SELECT * FROM ilanlar WHERE kategori = 2";
					$result = $conn->query($sql);
		...
		<div class=anasayfaKampanya>
			...
			<h1>GİYİM & AKSESUAR KAMPANYALARI</h1>
			<div class="kampanyaSlider">
				<div class="kampanyaListe">
					<?php
					// İlanları veritabanından çek ve kategoriye göre filtrele
					$sql = "SELECT * FROM ilanlar WHERE kategori = 3";
					$result = $conn->query($sql);
		...
		<div class=anasayfaKampanya>
			...
			<h1>ELEKTRONİK KAMPANYALARI</h1>
			<div class="kampanyaSlider">
				<div class="kampanyaListe">
					<?php
					// İlanları veritabanından çek ve kategoriye göre filtrele
					$sql = "SELECT * FROM ilanlar WHERE kategori = 4";
					$result = $conn->query($sql);
		...
		<div class=anasayfaKampanya>
			...
			<h1>EV & YAŞAM KAMPANYALARI</h1>
			<div class="kampanyaSlider">
				<div class="kampanyaListe">
					<?php
					// İlanları veritabanından çek ve kategoriye göre filtrele
					$sql = "SELECT * FROM ilanlar WHERE kategori = 5";
					$result = $conn->query($sql);
		...
		<div class=anasayfaKampanya>
			...
			<h1>AKTİVİTE & EĞLENCE KAMPANYALARI</h1>
			<div class="kampanyaSlider">
				<div class="kampanyaListe">
					<?php
					// İlanları veritabanından çek ve kategoriye göre filtrele
					$sql = "SELECT * FROM ilanlar WHERE kategori = 6";
					$result = $conn->query($sql);
		...
		<div class=anasayfaKampanya>
			<h1>SPOR & OUTDOOR KAMPANYALARI</h1>
			<div class="kampanyaSlider">
				<div class="kampanyaListe">
					<?php
					// İlanları veritabanından çek ve kategoriye göre filtrele
					$sql = "SELECT * FROM ilanlar WHERE kategori = 7";
					$result = $conn->query($sql);
		...
		<div class=anasayfaKampanya>
			...
			<h1>SAĞLIK KAMPANYALARI</h1>
			<div class="kampanyaSlider">
				<div class="kampanyaListe">
					<?php
					// İlanları veritabanından çek ve kategoriye göre filtrele
					$sql = "SELECT * FROM ilanlar WHERE kategori = 8";
					$result = $conn->query($sql);
		...
		<div class=anasayfaKampanya>
			...
			<h1>HİZMET KAMPANYALARI</h1>
			<div class="kampanyaSlider">
				<div class="kampanyaListe">
					<?php
					// İlanları veritabanından çek ve kategoriye göre filtrele
					$sql = "SELECT * FROM ilanlar WHERE kategori = 9";
					$result = $conn->query($sql);
