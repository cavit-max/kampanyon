...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/aramaSonuclari.css">
    <link rel="stylesheet" type="text/css" href="css/aramaBaslik.css">
...
<body>
    ...
    <div class="basliklar">
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            echo '<h2>"' . $aranan . '" İçin Arama Sonuçları </h2>';
        }
        ?>
    </div>
    ...
    <div class="content">
        <div class="kampanyalarGosterim">
            <?php
            // Arama formu gönderildiğinde çalışacak kodlar
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                // Arama kelimesini al
                $aranan = $_POST['aranan'];

                // İlanları veritabanından çek ve kategoriye ve arama kelimesine göre filtrele
                $sql = "SELECT * FROM ilanlar WHERE baslik LIKE '%$aranan%'";
